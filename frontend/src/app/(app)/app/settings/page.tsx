...
export default function SettingsPage() {
  ...
  const { username, loading: usernameLoading, hasUsername } = useUsername(walletAddress);
            ...
            <div className='space-y-4'>
              <div>
                ...
                <div className='flex gap-3'>
                  {usernameLoading ? (
                    <div className='flex-1 h-10 bg-neutral-200 dark:bg-neutral-700 rounded-lg animate-pulse' />
                  ) : (
                    <input
                      type='text'
                      value={hasUsername && username ? `@${username}` : 'Not registered'}
                      readOnly
                  ...
                  <Button variant='outline' className='font-poppins' disabled={usernameLoading}>
                    {hasUsername ? 'Change' : 'Register'}
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              <div className='flex items-center justify-between p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <p className='font-medium text-neutral-800 dark:text-neutral-100 font-poppins'>Connected Devices</p>
              ...
              <div className='flex items-center justify-between p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <p className='font-medium text-neutral-800 dark:text-neutral-100 font-poppins'>Change Password</p>
                    <p className='text-sm text-neutral-600 dark:text-neutral-400 font-poppins'>
              ...
              <div className='flex items-center justify-between p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-neutral-600 dark:text-neutral-400 font-poppins'>Currently enabled</p>
                  </div>
                </div>
                <label className='relative inline-flex items-center cursor-pointer'>
